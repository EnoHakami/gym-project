...
<div class='grid grid-cols-1 md:grid-cols-2 gap-14
    ...
    <div class={'flex flex-col gap-8 md:gap-10 pt-8 sm:-pt-10' +
        ...
        <p>{productFeatures.descripation}</p>
        <div class='flex flex-col gap-3'>
        {#each productFeatures.featureList as listItem}
            <div class='flex gap-2 items-center'>
                <div class='grid place-items-center px-1.5
                text-xs sm:text-sm aspect-square
                rounded-full border-[1.5px] bg-white
    ...
    <div class={"flex flex-col dropShadow overflow-hidden rounded-b-lg " }>
        ...
        <div class='flex flex-col bg-white gap-4 flex-1'>
            <img src={productFeatures.imgUrl} alt="product-img"/>
        </div>
